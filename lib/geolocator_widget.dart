...
class _GeolocatorWidgetState extends State<GeolocatorWidget> {
  ...
  //       children: [
  //         ElevatedButton(
  //           onPressed: _toggleServiceStatusStream,
  ...
  Future<void> _getCurrentPosition() async {
    ...
    try {
      ...
      // Catch-all for anything else (perm denied forever, etc.)
      debugPrint('Location error: $e\n$st');
      _updatePositionList(PositionItemType.log, e.toString());
    }
  }
  ...
  void _openAppSettings() async {
    ...
    _updatePositionList(PositionItemType.log, displayValue);
  }
